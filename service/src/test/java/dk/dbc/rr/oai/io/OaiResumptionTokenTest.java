...
public class OaiResumptionTokenTest {
    ...
    public void resumptionTokenOk() throws Exception {
        ...
        OaiResumptionToken before = new OaiResumptionToken("1970-01-01T00:00:00Z", null, "2134-12-31T23:59:59.999Z", "foo");
        String data = before.toData(Instant.MAX);
        System.out.println("data = " + data);
        OaiResumptionToken after = OaiResumptionToken.of(data);
    ...
    public void resumptionTokenOkWithNull1() throws Exception {
        ...
        OaiResumptionToken before = new OaiResumptionToken("1970-01-01T00:00:00Z", null, null, "");
        String data = before.toData(Instant.MAX);
        System.out.println("data = " + data);
        OaiResumptionToken after = OaiResumptionToken.of(data);
        assertThat(after, is(before));
    ...
    public void resumptionTokenOkWithNull2() throws Exception {
        ...
        OaiResumptionToken before = new OaiResumptionToken("1970-01-01T00:00:00Z", null, "2134-12-31T23:59:59.999Z", null);
        String data = before.toData(Instant.MAX);
        System.out.println("data = " + data);
        OaiResumptionToken after = OaiResumptionToken.of(data);
        assertThat(after, is(before));
    ...
    public void resumptionTokenExpired() throws Exception {
        ...
        OaiResumptionToken before = new OaiResumptionToken("1970-01-01T00:00:00Z", null, "2134-12-31T23:59:59.999Z", "foo");
        String data = before.toData(Instant.now().minusMillis(1));
        System.out.println("data = " + data);
        OaiResumptionToken after = OaiResumptionToken.of(data);
    ...
    public void resumptionTokenBadBase64() throws Exception {
        ...
        OaiResumptionToken token = OaiResumptionToken.of("01="); // .length % 4 != 0
    ...
    public void resumptionTokenTooShort() throws Exception {
        ...
        OaiResumptionToken token = OaiResumptionToken.of("012=");
        assertThat(token, nullValue());
    }
    ...
    public void resumptionTokenChecksumError() throws Exception {
        ...
        OaiResumptionToken token = OaiResumptionToken.of("0123456789==");
        assertThat(token, nullValue());
    }
